...
function mapboxGeojsonExample(callback) {
    ...
    var geojson = JSON.parse('[{"type":"Feature","geometry":{"type":"LineString","coordinates":[[-77.03238901390978,38.913188059745586],[-122.414,37.776]]},"properties":{"stroke":"#fc4353","stroke-width":5}}]');
    ...
    map.saveImage(path.join(__dirname, 'test-mapbox-image.png'), callback);
}
...
if (require.main === module) {
	...
	mapboxGeojsonExample(function (filename) {
